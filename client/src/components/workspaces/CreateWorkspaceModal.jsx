    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-lg bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
        ...
        <p className="text-xs text-slate-400 mb-6">
          Workspaces isolate your uploaded documents, agent chat histories, and
          vector embeddings.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              maxLength={255}
              placeholder="e.g., GenAI Research, System Design, Cybersecurity"
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={1024}
              rows={3}
              placeholder="Brief summary of what this workspace covers..."
